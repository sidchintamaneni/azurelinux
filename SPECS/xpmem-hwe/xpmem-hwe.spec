...
%{!?_mofed_full_version: %define _mofed_full_version 24.10-25%{release_suffix}%{?dist}}
...
%changelog
* Sun Dec 07 2025 Siddharth Chintamaneni <sidchintamaneni@gmail.com> - 2.7.4-25_6.18.0.1.1
